...
public class MyResourceEnvironmentFactory extends ResourceEnvironmentFactory {
    public ResourceEnvironment create(ResourceConfiguration resourceConfiguration) {
        ...
        ResourceService resourceService = new ResourceServiceFixForInlineInputStream(
                resourceLoaderMap,
                resourceLoaders,
